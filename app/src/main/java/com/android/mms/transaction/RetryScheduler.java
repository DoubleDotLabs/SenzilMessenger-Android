...
public class RetryScheduler implements Observer {
    ...
    private void markMmsFailed(final Context context, Uri msgUri) {
        ...
        // context.sendBroadcast(new Intent(com.doubledotlabs.senzil.send_message.Transaction.REFRESH));
        // context.sendBroadcast(new Intent(com.doubledotlabs.senzil.send_message.Transaction.NOTIFY_SMS_FAILURE));

        // broadcast that mms has failed and you can notify user from there if you would like
        context.sendBroadcast(new Intent(com.doubledotlabs.senzil.mmssms.Transaction.MMS_ERROR));
    }
