...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public NotificationTransaction(
        ...
        try {
            ...
            try {
                group = com.doubledotlabs.senzil.mmssms.Transaction.settings.getGroup();
            } catch (Exception e) {
            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    Uri uri = p.persist(pdu, Inbox.CONTENT_URI, true,
                            com.doubledotlabs.senzil.mmssms.Transaction.settings.getGroup(), null);
                    ...
                    mContext.sendBroadcast(new Intent(com.doubledotlabs.senzil.mmssms.Transaction.NOTIFY_OF_MMS));
                }
            }
