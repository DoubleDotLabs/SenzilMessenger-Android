...
/**
 * The senzil icon color can be changed. When it's changed, the senzil app must be closed. This
 * Receiver received the system broadcast that a package has changed, and re-launches senzil.
 */
public class IconColorReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_ICON_COLOR_CHANGED =
            "com.doubledotlabs.senzil.action.PENDING_PACKAGE_CHANGE";
    ...
    public static final String EXTRA_COMPONENT_NAME =
            "com.doubledotlabs.senzil.extra.EXTRA_COMPONENT_NAME";
    ...
    public static final String EXTRA_ICON_COLOR_CHANGED =
            "com.doubledotlabs.senzil.extra.EXTRA_ICON_COLOR_CHANGED";
