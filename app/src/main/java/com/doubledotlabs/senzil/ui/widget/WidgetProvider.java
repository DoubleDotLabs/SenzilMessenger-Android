...
package com.doubledotlabs.senzil.ui.widget;
...
public class WidgetProvider extends AppWidgetProvider {
    public static final String ACTION_NOTIFY_DATASET_CHANGED = "com.doubledotlabs.senzil.intent.action.ACTION_NOTIFY_DATASET_CHANGED";
