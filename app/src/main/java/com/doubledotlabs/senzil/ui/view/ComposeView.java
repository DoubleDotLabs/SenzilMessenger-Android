...
import com.doubledotlabs.senzil.common.utils.PhoneNumberUtils;
...
import com.doubledotlabs.senzil.interfaces.RecipientProvider;
import com.doubledotlabs.senzil.mmssms.Transaction;
import com.doubledotlabs.senzil.mmssms.Utils;
...
import com.doubledotlabs.senzil.ui.dialog.DefaultSmsHelper;
import com.doubledotlabs.senzil.ui.dialog.QKDialog;
import com.doubledotlabs.senzil.ui.dialog.mms.MMSSetupFragment;
...
public class ComposeView extends LinearLayout implements View.OnClickListener {
    ...
    public void onFinishInflate() {
        ...
        LiveViewManager.registerView(QKPreference.THEME, this, key -> {
            mComposeIcon.setColorFilter(ThemeManager.getTextOnBackgroundPrimary(), PorterDuff.Mode.SRC_ATOP);
            mAttach.setColorFilter(ThemeManager.getTextOnBackgroundPrimary(), PorterDuff.Mode.SRC_ATOP);
            mCamera.setColorFilter(ThemeManager.getTextOnBackgroundPrimary(), PorterDuff.Mode.SRC_ATOP);
            updateDelayButton();
    ...
    public void sendSms() {
        ...
        if (recipients != null && recipients.length > 0) {
            ...
            com.doubledotlabs.senzil.mmssms.Message message = new com.doubledotlabs.senzil.mmssms.Message(body, recipients);
