package com.doubledotlabs.senzil.ui;
...
import com.doubledotlabs.senzil.common.AnalyticsManager;
...
import com.doubledotlabs.senzil.common.utils.ColorUtils;
import com.doubledotlabs.senzil.common.utils.KeyboardUtils;
import com.doubledotlabs.senzil.common.utils.Units;
import com.doubledotlabs.senzil.enums.QKPreference;
import com.doubledotlabs.senzil.receiver.IconColorReceiver;
import com.doubledotlabs.senzil.theme.IconAdapter;
import com.doubledotlabs.senzil.ui.base.QKActivity;
import com.doubledotlabs.senzil.ui.dialog.ColorPickerPagerAdapter;
import com.doubledotlabs.senzil.ui.dialog.QKDialog;
import com.doubledotlabs.senzil.ui.settings.SettingsFragment;
import com.doubledotlabs.senzil.ui.view.QKEditText;
import com.doubledotlabs.senzil.ui.view.QKTextView;
import com.doubledotlabs.senzil.ui.view.colorpicker.ColorPickerPalette;
...
public class ThemeManager {
    ...
    public static void setIcon(final QKActivity context) {
        ...
        recyclerView.setAdapter(new IconAdapter(context, (parent, view, position, id) -> {
            ...
            for (int i = 0; i < colors.length; i++) {
                String componentClassName = String.format("com.doubledotlabs.senzil.ui.MainActivity-%s", colors[i]);
            ...
            // 2) relaunch senzil with the new component name.
    ...
    public static int getReceivedBubbleRes() {
        return R.drawable.message_received;
    }
    ...
    static class ColorPickerViewHolder {
        ...
        SeekBar mRed;
        @Bind(R.id.red_value)
        QKTextView mRedValue;
        @Bind(R.id.green)
        SeekBar mGreen;
        @Bind(R.id.green_value)
        QKTextView mGreenValue;
        @Bind(R.id.blue)
        SeekBar mBlue;
        @Bind(R.id.blue_value)
        QKTextView mBlueValue;
        @Bind(R.id.hex)
        QKEditText mHex;
        @Bind(R.id.error)
        ImageView mError;
