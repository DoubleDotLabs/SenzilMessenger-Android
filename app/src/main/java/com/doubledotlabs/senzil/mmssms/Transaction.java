...
package com.doubledotlabs.senzil.mmssms;
...
public class Transaction {
    ...
    public static final String MMS_ERROR = "com.doubledotlabs.senzil.send_message.MMS_ERROR";
    public static final String REFRESH = "com.doubledotlabs.senzil.send_message.REFRESH";
    public static final String MMS_PROGRESS = "com.doubledotlabs.senzil.send_message.MMS_PROGRESS";
    public static final String VOICE_FAILED = "com.doubledotlabs.senzil.send_message.VOICE_FAILED";
    public static final String VOICE_TOKEN = "com.doubledotlabs.senzil.send_message.RNRSE";
    public static final String NOTIFY_OF_DELIVERY = "com.doubledotlabs.senzil.send_message.NOTIFY_DELIVERY";
    public static final String NOTIFY_OF_MMS = "com.doubledotlabs.senzil.messaging.NEW_MMS_DOWNLOADED";
