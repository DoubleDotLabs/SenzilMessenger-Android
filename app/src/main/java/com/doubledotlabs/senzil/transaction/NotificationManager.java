package com.doubledotlabs.senzil.transaction;
...
import com.doubledotlabs.senzil.common.utils.ImageUtils;
...
import com.doubledotlabs.senzil.model.ImageModel;
import com.doubledotlabs.senzil.model.SlideshowModel;
import com.doubledotlabs.senzil.receiver.RemoteMessagingReceiver;
import com.doubledotlabs.senzil.ui.MainActivity;
import com.doubledotlabs.senzil.ui.ThemeManager;
import com.doubledotlabs.senzil.ui.messagelist.MessageItem;
import com.doubledotlabs.senzil.ui.messagelist.MessageListActivity;
import com.doubledotlabs.senzil.ui.popup.QKComposeActivity;
...
public class NotificationManager {
    ...
    public static final String ACTION_MARK_READ = "com.doubledotlabs.senzil.MARK_READ";
    public static final String ACTION_MARK_SEEN = "com.doubledotlabs.senzil.MARK_SEEN";
                    ...
                    if (conversationPrefs.getTickerEnabled()) {
                        switch (privateNotifications) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                builder.setTicker(String.format("%s: %s", "senzil", sRes.getString(R.string.new_message)));
                                break;
                        }
                    }
                ...
                for (Message message : SmsHelper.getFailedMessages(context)) {
                    switch (Integer.parseInt(sPrefs.getString(SettingsFragment.PRIVATE_NOTIFICATION, "0"))) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            inboxStyle.addLine(Html.fromHtml("<strong>" + "senzil" + "</strong> " + sRes.getString(R.string.new_message)));
                            break;
                    }
                }
    ...
    private static void singleSender(final Context context, ArrayList<MessageItem> messages, long threadId,
        ...
        if (privateNotifications == 2) notificationTitle = "senzil";
